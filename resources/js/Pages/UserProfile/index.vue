            ...
            <div class="flex justify-center pb-10">
                    ...
                    <div class="ml-10">
                        <div class="flex items-center">
                            ...
                            <inertia-link v-if="userProfile.id !== $page.props.user.id" :href="'/direct-message/'+userProfile.id" class="cursor-pointer h-7 px-3 ml-3 outline-none border-transparent text-center rounded border bg-blue-500 hover:bg-blue-600 text-white bg-transparent font-semibold">Enviar mensaje</inertia-link>
